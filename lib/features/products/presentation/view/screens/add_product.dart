...
import '../widgets/add_product/custom_drop_down_addproduct.dart';
                    ...
                    child: Column(
                      children: [
                        ...
                        CustomDropBottonAddProduct(
                          text: 'Select Category1',
                          list: cubit.categoriesList,
                          onChanged: (String? value) {
                            cubit.onCategory1Changed(value);
                          },
                          valueSelected: cubit.category1Seleted,
                        ),
                        SizedBox(
                          height: 15.h,
                        ),
                        CustomDropBottonAddProduct(
                          text: 'Select Category2',
                          list: cubit.categoriesList,
                          onChanged: (String? value) {
                            cubit.onCategory2Changed(value);
                          },
                          valueSelected: cubit.category2Seleted,
                        ),
                        SizedBox(
                          height: 15.h,
                        ),
                        ...
                        CustomBotton(
                          ...
                          onPressed: () {
                            if (cubit.formKey.currentState!.validate()) {
                              if (cubit.category1Seleted == null &&
                                  cubit.category2Seleted == null) {
                                customSnackBar(
                                  context,
                              ...
                              }else if (cubit.color1Seleted==null && cubit.color2Seleted ==null&& cubit.color3Seleted==null)
                              {
                                customSnackBar(
                                  context,
                                  'Please Select Color',
                              ...
                              }else if (cubit.size1Seleted ==null && cubit.size2Seleted == null && cubit.size3Seleted ==null)
                              {
                                customSnackBar(
                                  context,
                                  'Please Select Size',
